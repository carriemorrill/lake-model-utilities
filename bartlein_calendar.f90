...
! input: fixed day climate variable, 
...
integer(4)              :: agestep              ! age step size (interval between age calculations)
...
integer(4)              :: nsimyrs              ! number of years of simulation for each age
...
character(64)           :: variable            ! CMIP/PMIP variable name (e.g. "tas", "pr")
...
! these will get read in from python
	...
	nsimyrs = 1.   ! number of sim yrs per time, 1 for transient, >1 for equilibrium
...
var3d_in(1,1,8)=18.9
var3d_in(1,1,9)=17.3
var3d_in(1,1,10)=16.8
var3d_in(1,1,11)=15.4
var3d_in(1,1,12)=14.9

!      do j=1,nt
!        read(10,*) var3d_in(1,1,j)
!      end do
...
!************************************************************************
! Step 8:  Write out and deallocate
!************************************************************************    
     do j=1,nt
	    write(*,*) var3d_out(1,1,j)
     end do
